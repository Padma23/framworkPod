 ...
 **/
@interface FillschemeRoot : GPBRootObject
@end

#pragma mark - FillScheme

typedef GPB_ENUM(FillScheme_FieldNumber) {
  FillScheme_FieldNumber_Id_p = 1,
  FillScheme_FieldNumber_Name = 2,
  FillScheme_FieldNumber_FillArray = 3,
  FillScheme_FieldNumber_Modified = 4,
  FillScheme_FieldNumber_ThemeId = 99,
};

@interface FillScheme : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Fill*> *fillArray;
/** The number of items in @c fillArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger fillArray_Count;
