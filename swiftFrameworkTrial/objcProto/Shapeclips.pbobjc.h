 ...
 **/
@interface ShapeclipsRoot : GPBRootObject
@end

#pragma mark - ShapeClips

typedef GPB_ENUM(ShapeClips_FieldNumber) {
  ShapeClips_FieldNumber_ShapesArray = 1,
  ShapeClips_FieldNumber_AnimListArray = 2,
};

@interface ShapeClips : GPBMessage
