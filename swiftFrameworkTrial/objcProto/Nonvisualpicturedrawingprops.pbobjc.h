 ...
 **/
@interface NonvisualpicturedrawingpropsRoot : GPBRootObject
@end

#pragma mark - NonVisualPictureDrawingProps

typedef GPB_ENUM(NonVisualPictureDrawingProps_FieldNumber) {
  NonVisualPictureDrawingProps_FieldNumber_Locks = 1,
};

@interface NonVisualPictureDrawingProps : GPBMessage
